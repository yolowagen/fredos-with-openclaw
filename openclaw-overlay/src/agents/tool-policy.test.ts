...
describe("tool-policy", () => {
  ...
  it("resolves known profiles and ignores unknown ones", () => {
    ...
    const codingProject = resolveToolProfilePolicy("coding-project");
    expect(codingProject?.allow).toContain("read");
    expect(codingProject?.allow).toContain("web_search");
    expect(codingProject?.allow).toContain("sessions_spawn");
    expect(codingProject?.allow).toContain("agents_list");
    expect(codingProject?.allow).not.toContain("cron");
    expect(codingProject?.allow).not.toContain("memory_search");
